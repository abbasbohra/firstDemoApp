...
const ExampleFeatureAllProduct = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={{ height: 90, }}>
        <Header title='Feature Products' showShadow={false} searchLeft={-10} cartleft={-10} onpress={() => navigation.goBack()} />
...
export default ExampleFeatureAllProduct;
