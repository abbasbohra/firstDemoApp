...
const ExampleTopAllProduct = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={{ height: 80, }}>
        <Header title='Top Products' showShadow={false} searchLeft={-10} cartleft={-10} onpress={() => navigation.goBack()} />
...
export default ExampleTopAllProduct