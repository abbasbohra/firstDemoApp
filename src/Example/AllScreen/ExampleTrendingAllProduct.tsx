import { View, Text, FlatList, TouchableOpacity, ToastAndroid, Image, Alert, Pressable, ImageBackground, Dimensions } from 'react-native'
...
const ExampleTrendingAllProduct = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={{ height: 80, }}>
        <Header title='Trending Products' showShadow={false} searchLeft={-10} cartleft={-10} onpress={() => navigation.goBack()} />
...
export default ExampleTrendingAllProduct