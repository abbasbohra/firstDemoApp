...
const ExampleCancelAllProduct = ({ route, navigation }: { route: any, navigation: any }) => {
    ...
    console.log('orderItemid', selectProduct)
    ...
    const cancelProduct = () => {
        ...
        orderDetail?.forEach((item, index) => {
            body.append('order_id', item?.id.toString())
        })
    ...
    return (
        ...
        <ScrollView style={{}} contentContainerStyle={{ backgroundColor: "white", paddingBottom: 200 }}>
            <Header title='ORDER CANCEL' cartleft={-10} showShadow={true} searchLeft={-10} titleStyle={{ top: 20, left: 100, fontSize: 20, color: 'black', fontWeight: '500' }} />
                            ...
                            <View style={{ backgroundColor: "white", width: '95%', height: 200, shadowColor: "black", shadowOffset: { width: 1, height: 1 }, shadowOpacity: 1, shadowRadius: 1, elevation: 2, top: 0, margin: 5, paddingBottom: 10, left: 5 }}>
                                ...
                                <FlatList
                                    ...
                                    renderItem={({ item, index }: { item: any, index: any }) => {
                                        return (
                                            <View style={{ margin: 5 }}>
                                                <View style={{ shadowColor: "black", shadowOffset: { width: 1, height: 1 }, shadowOpacity: 1, shadowRadius: 1, elevation: 5, backgroundColor: 'white', width: 110, height: 110, margin: 10, top: 0 }}>
            ...
            <TouchableOpacity style={{ backgroundColor: "#27AAE1", shadowColor: "black", shadowOffset: { width: 1, height: 1 }, shadowOpacity: 1, shadowRadius: 1, elevation: 5, marginLeft: 20, marginRight: 20, borderRadius: 20, top: 150 }} onPress={() => cancelProduct()}>
                ...
                >
                    <View style={style.loadingmodalcon}>
                        <View style={style.loadingmodalstyle}>
                            <ActivityIndicator color={'black'} size={30} style={style.loader} />
...
export default ExampleCancelAllProduct;
