import { View, Text, TextInput, KeyboardAvoidingView, Image, ToastAndroid, Modal, ActivityIndicator, Alert, Pressable, TouchableOpacity } from 'react-native'
  ...
  return (
    <KeyboardAvoidingView style={{ backgroundColor: 'white', flex: 1 }}>
      ...
      <View style={{ top: 150 }}>
        ...
        <View style={{ borderWidth: 1, borderColor: 'white', width: 350, left: 15, backgroundColor: "white", shadowColor: "black", shadowOpacity: 1, shadowOffset: { width: 1.5, height: 1.5 }, elevation: 6, shadowRadius: 1, borderRadius: 5, top: 20 }}>
        ...
        <View style={{ borderWidth: 1, borderColor: 'white', width: 350, left: 15, backgroundColor: "white", shadowColor: "black", shadowOpacity: 1, shadowOffset: { width: 1.5, height: 1.5 }, elevation: 6, shadowRadius: 1, borderRadius: 5, top: 40 }}>
        ...
        <View style={{ flexDirection: "row", borderWidth: 1, borderColor: 'white', width: 350, left: 15, backgroundColor: "white", shadowColor: "black", shadowOpacity: 1, shadowOffset: { width: 1.5, height: 1.5 }, elevation: 6, shadowRadius: 1, borderRadius: 5, top: 60 }}>
          ...
          <TextInput
            ...
            placeholderTextColor={'black'}
          />
          <Icon name='ios-eye' color="black" size={25} style={{ top: 10, left: 15 }} />
        </View>

        <View style={{ flexDirection: "row", borderWidth: 1, borderColor: 'white', width: 350, left: 15, backgroundColor: "white", shadowColor: "black", shadowOpacity: 1, shadowOffset: { width: 1.5, height: 1.5 }, elevation: 6, shadowRadius: 1, borderRadius: 5, top: 80 }}>
      ...
      <TouchableOpacity onPress={() => signUp()} disabled={checked ? false : true} style={{ top: 280, borderRadius: 5, width: 350, left: 13, backgroundColor: checked ? "#27AAE1" : 'grey', shadowColor: "black", shadowOffset: { width: 10, height: 10 }, shadowOpacity: 10, shadowRadius: 10, elevation: 5 }}>
